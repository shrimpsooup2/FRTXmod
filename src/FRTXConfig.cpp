    ...
    void applyPreset(FRTXConfig& cfg, FRTXPreset preset) {
        switch (preset) {
            ...
            case FRTXPreset::Subtle:
                ...
                cfg.bloomIntensity = 0.70f;
                cfg.bloomThreshold = 0.85f;
                cfg.bloomKnee = 0.30f;
                cfg.bloomRadius = 1.0f;
                cfg.bloomLevels = 2;
                cfg.bloomScale = 0.5f;
                cfg.emissiveBias = 0.50f;
                cfg.streakIntensity = 0.15f;
                cfg.streakLength = 1.0f;
            ...
            case FRTXPreset::Showcase:
                cfg.bloomEnabled = true;
                cfg.bloomIntensity = 1.45f;
                cfg.bloomThreshold = 0.62f;
                cfg.bloomKnee = 0.35f;
                cfg.bloomRadius = 1.5f;
                cfg.bloomLevels = 3;
                cfg.bloomScale = 0.5f;
                cfg.emissiveBias = 0.65f;
                cfg.streakIntensity = 0.45f;
                cfg.streakLength = 1.4f;
                cfg.tonemapEnabled = true;
                cfg.exposure = 1.08f;
                cfg.contrast = 1.12f;
                cfg.saturation = 1.22f;
                cfg.temperature = 0.10f;
                cfg.tint = 0.0f;
                cfg.clarity = 0.40f;
                cfg.clarityRadius = 6.0f;
                cfg.blackPoint = 0.035f;
                cfg.splitShadow = 0.40f;
                cfg.splitHighlight = 0.35f;
                cfg.vignette = 0.35f;
                cfg.chromatic = 0.18f;
                cfg.grain = 0.015f;
                cfg.dither = true;
            ...
            case FRTXPreset::Overkill:
                ...
                cfg.streakIntensity = 0.90f;
                cfg.streakLength = 2.2f;
                cfg.tonemapEnabled = true;
                cfg.exposure = 1.15f;
                cfg.contrast = 1.20f;
                ...
                cfg.tint = 0.0f;
                cfg.clarity = 0.60f;
                cfg.clarityRadius = 8.0f;
                cfg.blackPoint = 0.060f;
                cfg.splitShadow = 0.60f;
                cfg.splitHighlight = 0.55f;
                cfg.vignette = 0.45f;
                cfg.chromatic = 0.35f;
                cfg.grain = 0.030f;
                cfg.dither = true;
